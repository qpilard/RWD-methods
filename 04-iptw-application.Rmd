...
The ITT analysis discussed in the \@ref(specify-the-target-trial) will be applied to illustrate the application of IPTW.
...
This models the treatment effect accross the entire population likely to receive either Sertralex or Duloxyn. Additional details on the causal estimand are provided in Appendix \@ref(r-code-simu).
